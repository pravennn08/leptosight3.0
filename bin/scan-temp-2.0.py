...
class ScanTemperaturePage(ctk.CTkFrame):
    def __init__(self, master, controller):
        ...
        # ICONS
        self.scan_icon = ctk.CTkImage(Image.open(TEMP), size=(60, 60))
        ...
        self.scan_temp_btn.place(relx=0.5, rely=0.10, anchor=ctk.N)
        ...
        self.save_temp_btn.place(relx=0.5, rely=0.40, anchor=ctk.N)
